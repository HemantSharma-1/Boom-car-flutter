...
CarInformationModel carInformationModelFromMap(String str) =>
    CarInformationModel.fromMap(json.decode(str));

String carInformationModelToMap(CarInformationModel data) =>
...
class CarInformationModel {
  ...
  factory CarInformationModel.fromMap(Map<String, dynamic> json) =>
      CarInformationModel(
        id: json["id"],
        city: json["city"],
        carLocation: json["carLocation"],
        hostedBy: json["hostedBy"] == null
            ? null
            : HostedBy.fromMap(json["hostedBy"]),
        car: json["car"] == null ? null : Car.fromMap(json["car"]),
        carImages: json["carImages"] == null
            ? []
            : List<CarImage>.from(
                json["carImages"]!.map((x) => CarImage.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "carImages": carImages == null
            ? []
            : List<dynamic>.from(carImages!.map((x) => x.toMap())),
